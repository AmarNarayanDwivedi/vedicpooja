    ...
    >
      <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <ul>
            {specialPoojas.map((pooja) => (
              <li key={pooja} className="mb-2">
                <Link href="/pooja" className="group hover:text-white transition-colors relative inline-block">
        ...
        <div>
          ...
          <ul>
            <li className="mb-2">
              <Link href="/about" className="group hover:text-white transition-colors relative inline-block">
                <span className="absolute -bottom-0.5 left-0 h-0.5 w-full bg-orange-200/60 scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-center" />
                {t.navAbout}
              </Link>
            </li>
            ...
            <li className="mb-2">
              <Link href="/blog" className="group hover:text-white transition-colors relative inline-block">
                <span className="absolute -bottom-0.5 left-0 h-0.5 w-full bg-orange-200/60 scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-center" />
                {t.navBlog}
              </Link>
            </li>

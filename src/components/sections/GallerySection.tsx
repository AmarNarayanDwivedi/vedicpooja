...
const galleryVid1 = "/assets/HeroPage/pooja_glimpshiss/video/Pooja_Setup_Video_Creation.webm";
const galleryVid2 = "/assets/HeroPage/pooja_glimpshiss/video/Pooja_Video_Generation_Complete.webm";
const galleryVid3 = "/assets/HeroPage/pooja_glimpshiss/video/Pooja_Video_Generation_For_Website.webm";
const galleryVid4 = "/assets/HeroPage/pooja_glimpshiss/video/VID_20250722_063314_767.webm";
        ...
        >
          ...
          >
            {mediaRow1.map((item, index) => (
              <div
                key={`r1-${index}`}
                className="flex-shrink-0 relative w-[400px] h-[250px] overflow-hidden rounded-lg shadow-lg"
              >
                {item.type === "image" ? (
                  <Image
                    src={item.src as string | StaticImageData}
                  ...
                  <video
                    src={(item.src as any).src || item.src}

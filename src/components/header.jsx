...
export default function Header() {
  ...
  return (
    <header
      className={`header-sticky fixed w-full z-50 top-0 transition-all duration-300 ${
        isScrolled
    ...
    >
      ...
      <div
        className={`md:hidden fixed top-0 right-0 h-screen w-80 bg-white shadow-2xl transform transition-transform duration-300 ease-in-out z-40 ${

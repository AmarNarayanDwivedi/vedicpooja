      ...
      <div className="container mx-auto px-6">
        ...
        <div className="relative max-w-4xl mx-auto">
          ...
          {timelineData.map((item, index) => (
            <div
              key={index}
              className={`flex items-center w-full mb-12 fade-in-scroll ${
            ...
            >
              ...
              <div
                className={`absolute left-1/2 -translate-x-1/2 w-8 h-8 rounded-full shadow-lg z-10 timeline-dot ${
                  item.highlight
  ...
  return (
    <section className="py-20 md:py-24 relative z-10">
      <div className="container mx-auto px-6">
        <div className="text-center mb-12 fade-in-scroll">
          <h2 className="font-playfair text-4xl md:text-5xl font-bold text-secondary">
            {translations[lang].whyChooseUsTitle}
          </h2>
        </div>
